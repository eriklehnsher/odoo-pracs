...
fix lỗi warning: in the working copy of 'addons_custom/my_library/views/res_partner_inherit_view.xml', LF will be replaced by CRLF the next time Git touches it
