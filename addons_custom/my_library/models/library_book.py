...
class LibraryBook(models.Model):
    ...
    reader_rating = fields.Float('Reader Average Rating', (14,4))  # trung bình đánh giá của người đọc( 14 digits in total, 4 after the decimal point - số lượng chữ số sau dấu phẩy là 4 chữ số sau dấu phẩy)
